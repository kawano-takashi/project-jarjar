...
func test_names() -> PackedStringArray:
	return PackedStringArray([
		"revision_eleven_envelope_and_exterior_grid",
...
func run_test(test_name: String, assertions: Variant, _context: Dictionary) -> void:
	match test_name:
		...
		_:
			assertions.expect_true(false, "registered revision eleven enemy-spatial test")
...
func _test_boss_charge(assertions: Variant) -> void:
	...
	assertions.expect_equal(110, phase_one_interval, "revision eleven phase-one action rate rounds up to 110 ticks")
	assertions.expect_equal(82, phase_two_interval, "revision eleven phase-two action rate rounds up to 82 ticks")
	assertions.expect_equal(62, phase_three_interval, "revision eleven phase-three action rate rounds up to 62 ticks")
...
func _catalog(assertions: Variant) -> DefinitionCatalog:
	...
	assertions.expect_true(catalog.load_and_validate(), "revision eleven content catalog validates")
