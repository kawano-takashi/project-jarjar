...
func test_names() -> PackedStringArray:
	return PackedStringArray([
		"revision_twelve_envelope_and_exterior_grid",
...
func run_test(test_name: String, assertions: Variant, _context: Dictionary) -> void:
	match test_name:
		...
		_:
			assertions.expect_true(false, "registered revision twelve enemy-spatial test")
...
func _test_boss_charge(assertions: Variant) -> void:
	...
	assertions.expect_equal(110, phase_one_interval, "revision twelve phase-one action rate rounds up to 110 ticks")
	assertions.expect_equal(82, phase_two_interval, "revision twelve phase-two action rate rounds up to 82 ticks")
	assertions.expect_equal(62, phase_three_interval, "revision twelve phase-three action rate rounds up to 62 ticks")
