...
func _test_all_content_fixed_contract(assertions: Variant) -> void:
	...
	assertions.expect_float(
		...
		"revision eleven preserves the calibrated elite HP",
	)
...
func _test_boss_enrage_validation(assertions: Variant) -> void:
	...
	assertions.expect_float(1.6875, canonical.boss_hp_multiplier, "revision eleven preserves the prior boss HP pending recalibration")
...
func _test_segment_tuning_contract(assertions: Variant) -> void:
	...
	assertions.expect_false(
		...
		"revision eleven rejects target drift",
	)
	...
	assertions.expect_false(
		...
		"revision eleven rejects HP drift",
	)
	...
	assertions.expect_false(
		...
		"revision eleven rejects damage drift",
	)
	...
	assertions.expect_false(
		...
		"revision eleven rejects spawn-weight drift even when weights sum to one",
	)
