...
最新の全GDScript回帰も112/112でPASSしています。
...
ただし、正式candidateと正式playtest targetは未固定です。Full HD性能試験、Release export、Verify、ManualQa、
人間playtestはすべて未実施で、ユーザーが最終調整完了を明示するまで実行禁止です。
...
revision 5の証拠として無効であり、履歴としてのみ保持します。
