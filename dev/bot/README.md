...
未進化での突破を比較する場合は `--bot-evolution-after-tick=28800` を追加します。8分まで進化宝箱を回収しないよう、見えている宝箱と通常の案内を使って移動します。既定値は0（回収を遅らせない）、整数tick（60/秒）で0〜108000を指定できます。戦闘や宝箱の成立条件は変えません。偶然回収した場合も実際の初進化時刻を報告します。
